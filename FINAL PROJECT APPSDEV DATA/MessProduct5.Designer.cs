namespace WindowsFormsAppMilkyWay
{
	partial class MessProduct5
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MessProduct5));
			...
			this.label2.Text = "Phone: +63 2 7507 1446";
			// 
			// label3
			// 
			...
			this.label3.Text = "Email: AFPHPubRel@arlafoods.com";
			// 
			// MessProduct5
			// 
			...
			this.Name = "MessProduct5";
			this.Text = "MessProduct5";
