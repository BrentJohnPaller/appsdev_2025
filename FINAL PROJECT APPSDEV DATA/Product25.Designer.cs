namespace WindowsFormsAppMilkyWay
{
	partial class Product25
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Product25));
			this.Product25panel = new System.Windows.Forms.Panel();
			...
			this.Product25panel.SuspendLayout();
			this.SuspendLayout();
			// 
			// Product25panel
			// 
			this.Product25panel.BackColor = System.Drawing.Color.White;
			this.Product25panel.Controls.Add(this.back);
			this.Product25panel.Controls.Add(this.label1);
			this.Product25panel.Controls.Add(this.contact_seller1);
			this.Product25panel.Controls.Add(this.richTextBox1);
			this.Product25panel.Controls.Add(this.label2);
			this.Product25panel.Controls.Add(this.label4);
			this.Product25panel.Controls.Add(this.panel6);
			this.Product25panel.Location = new System.Drawing.Point(0, 0);
			this.Product25panel.Name = "Product25panel";
			this.Product25panel.Size = new System.Drawing.Size(773, 925);
			this.Product25panel.TabIndex = 32;
			// 
			// back
			// 
			...
			this.contact_seller1.Click += new System.EventHandler(this.contact_seller1_Click);
			// 
			// richTextBox1
			// 
			...
			this.label4.Text = "Alaska Fortified Milk  Drink 170ml";
			// 
			// panel6
			// 
			...
			this.panel6.Size = new System.Drawing.Size(201, 280);
			...
			this.Controls.Add(this.Product25panel);
			this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
			this.Name = "Product25";
			this.Text = "Product25";
			this.Product25panel.ResumeLayout(false);
			this.Product25panel.PerformLayout();
		...
		private System.Windows.Forms.Panel Product25panel;
